...
import dislinkt.loggingservice.security.auth.RestAuthenticationEntryPoint;
import dislinkt.loggingservice.security.auth.TokenAuthenticationFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .antMatchers("/events/**").permitAll().antMatchers("/actuator/**").permitAll()
